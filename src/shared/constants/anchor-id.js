// These constants are used to refer to specific sections of the page for easy navigation and scrolling

const SCROLL_PAGE_MAIN_HEADER = 'main-header';
...
const SCROLL_PAGE_MAIN_FOOTER = 'main-footer';


export {
    SCROLL_PAGE_MAIN_HEADER,
